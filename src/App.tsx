import { Box, FormControlLabel, Input, InputLabel, Radio, RadioGroup, Stack } from '@mui/material';
...
const IceCreamContext = createContext<{ flavors: string[], filter: string, updateFilter: (filter: string) => void }>({ } as any);
